...
* User Documentation
  How to use Async Http Client - Clojure a.k.a. *http.async*.
** Quick start
...
#+BEGIN_SRC clojure
  (defproject your-project "1.0.0-SNAPSHOT"
    ...
    :dependencies [[org.clojure/clojure "1.2.0"]
                   ...
                   [http.async "2.0.0"]])
#+END_SRC
    Make sure that your project depends on 1.2 Clojure as *http.async*
...
#+BEGIN_SRC clojure
  (c/GET url)
#+END_SRC
     Result will be a map of http.async.client.util/promise called response.
...
#+END_SRC
     ...
     - *:body* :: body to be sent, allowed only with PUT/POST
...
**** GET
    ...
    accepted by *http.async.client.request/prepare-request* (:headers :query ..).
...
**** Call-back
   ...
   *http.async*. You will need to know what HTTP Method you will call,
