...
* Build status
  ...
  commits on both the master branch ([[https://secure.travis-ci.org/cch1/http.async.client.png?branch=master]])
  and the development branch ([[https://secure.travis-ci.org/cch1/http.async.client.png?branch=development]]).
