...
* Build status [[https://secure.travis-ci.org/cch1/http.async.client.png?branch=master]] [[https://secure.travis-ci.org/cch1/http.async.client.png?branch=development]]
  [[https://travis-ci.org/cch1/http.async.client][TravisCI]] is used to track the build status of intermediate commits
  on both the master branch and the development branch.
