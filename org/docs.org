...
** GETting
   ...
   #+BEGIN_SRC clojure
     (with-open [client (http/create-client)] ; Create client
       (let [response (http/GET client "http://github.com/cch1/http.async.client/")] ; request http resource
         (-> response
...
*** Asynchronous operations
    ...
    - [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-GET][GET]]
    - [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-POST][POST]]
    - [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-PUT][PUT]]
    - [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-DELETE][DELETE]]
    - [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-HEAD][HEAD]]
    - [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-OPTIONS][OPTIONS]]
    ...
    - *:body* :: body to be sent, allowed only with [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-PUT][PUT]]/[[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-POST][POST]]
...
*** GET
    Most basic invocation of [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-GET][*http.async.client/GET*]] is only with
    *url* you want to get.
    Extended invocation includes options that can be any options
    accepted by [[http://cch1.github.io/http.async.client/doc/http.async.client.request.html#var-prepare-request][*http.async.client.request/prepare-request*]]
    [:headers :query ..].
    ...
    #+END_SRC
    Notice [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-cookies][*http.async.client/cookies*]] function extracts cookies from
    response headers, so to start processing it you don't need to wait
    for whole response to arrive.
*** PUT/POST
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-PUT][*http.async.client/PUT*]]/[[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-POST][*http.async.client/POST*]] work the same
...
**** Submitting body as File, a.k.a. zero byte copy
     ...
     #+end_src
*** DELETE
    To call [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-DELETE][*http.async.client/DELETE*]] on a resource:
    #+BEGIN_SRC clojure
      (with-open [client (http/create-client)] ; Create client
    ...
    #+END_SRC
*** HEAD
    To call [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-HEAD][*http.async.client/HEAD*]] on a resource:
    #+BEGIN_SRC clojure
      (with-open [client (http/create-client)] ; Create client
    ...
    #+END_SRC
*** OPTIONS
    To call [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-OPTIONS][*http.async.client/OPTIONS*]] on a resource:
    #+BEGIN_SRC clojure
      (with-open [client (http/create-client)] ; Create client
...
** Request options
   ...
   [[http://cch1.github.io/http.async.client/doc/http.async.client.request.html#var-prepare-request][*http.async.client.request/prepare-request*]]:
...
*** Awaiting response
    ...
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-await][*http.async.client/await*]].
    ...
    #+END_SRC
*** Reading status line
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-status][*http.async.client/status*]] returns status lazy map of response.
    ...
    yet.
*** Is redirect?
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-redirect%3F][*http.async.client/redirect?*]] checks if response is redirect.
    #+BEGIN_SRC clojure
      (with-open [client (http/create-client)] ; Create client
    ...
    #+END_SRC
*** Reading headers
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-headers][*http.async.client/headers*]] returns headers lazy map of response.
...
*** Reading content-type
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-content-type][*http.async.client/content-type*]] returns value of *Content-Type*
    header.
    #+BEGIN_SRC clojure
      (with-open [client (http/create-client)] ; Create client
        (let [resp         (http/GET client url)
    ...
    #+END_SRC
*** Reading location
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-location][*http.async.client/location*]] will return redirect target if
    ...
    #+END_SRC
*** Reading cookies
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-cookies][*http.async.client/cookies*]] returns seq of maps representing
    cookies.
    It will wait until HTTP Headers are received.
    #+BEGIN_SRC clojure
      (with-open [client (http/create-client)] ; Create client
    ...
    set.
*** Reading body
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-body][*http.async.client/body*]] returns either ByteArrayOutputStream or
...
*** Reading body as string
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-string][*http.async.client/string*]] returns either string or seq of
    ...
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-string][*http.async.client/string*]] is lazy so you can use it in case of
    streams as well.
    #+BEGIN_SRC clojure
      (with-open [client (http/create-client)] ; Create client
        (let [resp    (http/stream-seq client :get url)
...
*** Reading error
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-error][*http.async.client/error*]] will return Throwable that was cause of
...
*** Canceling request
    ...
    by calling [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-cancel][*http.async.client/cancel*]].
    #+BEGIN_SRC clojure
      (with-open [client (http/create-client)] ; Create client
        (let [resp (http/GET client url)]
          (http/cancel resp)))
...
**** done?
     [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-done?][*http.async.client/done?*]] will tell you if response processing
     has finished:
     #+BEGIN_SRC clojure
       (with-open [client (http/create-client)] ; Create client
         (let [resp (http/GET client url)]
...
**** failed?
     [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-failed?][*http.async.client/failed?*]] will return true iff request has
     failed. If this return true you can [[*Reading%20error][read error]].
**** canceled?
     [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-canceled?][*http.async.client/canceled?*]] will return true iff request has
...
*** Requested URL
    ...
    - :url :: encoded url,
    - :raw-url :: not encoded url - DEPRECATED.

    And two convenience functions:
    - [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-url][*http.async.client/url*]],
    - [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-raw-url][*http.async.client/raw-url*]] (DEPRECATED).

** Managing client
*** Branding
    *http.async.client* can be configured with User-Agent. To do so
    you can use [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-create-client][*http.async.client/create-client*]] and remember to
...
*** SSL Certificates
    ...
    [[http://cch1.github.io/http.async.client/doc/http.async.client.cert.html#var-ssl-context][*http.async.client.cert/ssl-context*]] and tests.

*** Closing *http.async.client*
    Whenever you've created *http.async.client* via
    [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-create-client][*http.async.client/create-client*]] you will need to close it.
    To do so you call [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-close][*http.async.client/close*]].
    #+BEGIN_SRC clojure
...
* Low level
  ...
  execute requests.
** Preparing request
   [[http://cch1.github.io/http.async.client/doc/http.async.client.request.html#var-prepare-request][*http.async.client.request/prepare-request*]] is responsible for
  ...
  - and *options*, a keyworded map described already in [[*Request%20options][Request options]].
    ...
    #+END_SRC
** Executing request
   [[http://cch1.github.io/http.async.client/doc/http.async.client.request.html#var-execute-request][*http.async.client.request/execute-request*]] returns same map of promises
...
*** Error
    ...
    #+end_src
** Default callbacks
   [[http://cch1.github.io/http.async.client/doc/http.async.client.request.html#var-*default-callbacks*][*http.async.client.request/*default-callbacks**]] is a map of
   default callbacks. This will allow you to easy change only few
   callbacks and reuse default for the rest.

   Please look at source of [[http://cch1.github.io/http.async.client/doc/http.async.client.html#var-stream-seq][*http.async.client/stream-seq*]] to see
   how to do it.
