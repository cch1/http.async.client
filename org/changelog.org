...
** There is an issue with the AsyncHttpClient Java library. See https://github.com/AsyncHttpClient/async-http-client/issues/996. To workaround, set a realm with {:preemptive true :target-proxy true}.
* Release 0.6.1
